...
public final class AppDatabase_Impl extends AppDatabase {
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS `water_entries` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `amountMl` INTEGER NOT NULL, `timestampEpochMillis` INTEGER NOT NULL, `dayEpochDay` INTEGER NOT NULL)");
        db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '3fda7d28bee214d004bad86e53f91535')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        _columnsWaterEntries.put("timestampEpochMillis", new TableInfo.Column("timestampEpochMillis", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsWaterEntries.put("dayEpochDay", new TableInfo.Column("dayEpochDay", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (!_infoWaterEntries.equals(_existingWaterEntries)) {
          return new RoomOpenHelper.ValidationResult(false, "water_entries(com.factory.aquacoachsmarthydrationai.data.local.WaterEntry).\n"
                  + " Expected:\n" + _infoWaterEntries + "\n"
                  + " Found:\n" + _existingWaterEntries);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "3fda7d28bee214d004bad86e53f91535", "50729489a43376ccaf4675a01bd25294");
  ...
  protected InvalidationTracker createInvalidationTracker() {
    ...
    return new InvalidationTracker(this, _shadowTablesMap, _viewTables, "water_entries");
  }
